...
<head>
  ...
  <title>Dharmik Anushtan-Puja Detail</title>
      ...
      <div class="col-md-10">
        ...
        <div class="row">
          ...
          <!-- <div class="col-md-4">
            ...
            <div class='card' >
  <img src='images/ganeshpuja.avif' class='card-img-top' alt='$puja_title'>
  <div class='card-body'>
    <h5 class='card-title'>$puja_title</h5>
    <p class='card-text'>$puja_description</p>
    <a href='#' class='btn btn-primary'>Book Puja</a>
    <a href='puja_details.php?puja_id=$puja_id' class='btn btn-secondary'>Know More</a>
  </div>
</div>
         </div> -->
          ...
          <!-- <div class="col-md-8">
             ...
             <div class="row">
                <div class="col-md-12">
                    <h4 class="text-center text-secondary py-3 mb-5">Related Images</h4>
                </div>
                <div class="col-md-6">
                <img src='images/ganeshpuja.avif' class='card-img-top' alt='$puja_title'>
                </div>
...
// </div> -->
      ...
      <div class="col-md-2  custom-sidebar p-0">
        ...
        <ul class="navbar-nav me-auto text-center">
          <li class="nav-item custom-header">
            <a href="" class="nav-link ourpujalocal">
              <h4>Mod of Puja</h4>
            </a>
          </li>
